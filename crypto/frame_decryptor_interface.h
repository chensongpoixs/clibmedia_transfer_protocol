...
#ifndef _C_API_CRYPTO_FRAME_DECRYPTOR_INTERFACE_H_
#define _C_API_CRYPTO_FRAME_DECRYPTOR_INTERFACE_H_
...
class FrameDecryptorInterface : public rtc::RefCountInterface {
 public:
  ...
  // cases.
  virtual Result Decrypt(libmedia_transfer_protocol::MediaType media_type,
  ...
  virtual size_t GetMaxPlaintextByteSize(libmedia_transfer_protocol::MediaType media_type,

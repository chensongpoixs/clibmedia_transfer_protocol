...
class FrameEncryptorInterface : public rtc::RefCountInterface {
 public:
  ...
  virtual int Encrypt(libmedia_transfer_protocol::MediaType media_type,
                      uint32_t ssrc,
  ...
  virtual size_t GetMaxCiphertextByteSize(libmedia_transfer_protocol::MediaType media_type,
                                          size_t frame_size) = 0;
};

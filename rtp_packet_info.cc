...
RtpPacketInfo::RtpPacketInfo()
    : ssrc_(0), rtp_timestamp_(0), receive_time_(webrtc::Timestamp::MinusInfinity()) {}
...
RtpPacketInfo::RtpPacketInfo(
    ...
    : RtpPacketInfo(ssrc,
                    ...
                    webrtc::Timestamp::Millis(receive_time_ms)) {}
RtpPacketInfo::RtpPacketInfo(const RTPHeader& rtp_header,
                             int64_t receive_time_ms)
    : RtpPacketInfo(rtp_header, webrtc::Timestamp::Millis(receive_time_ms)) {}

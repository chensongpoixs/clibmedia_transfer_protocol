...
#ifndef _C_API_RTP_PACKET_INFO_H_
#define _C_API_RTP_PACKET_INFO_H_
...
class RTC_EXPORT RtpPacketInfo {
 public:
  ...
  RtpPacketInfo(const RTPHeader& rtp_header, webrtc::Timestamp receive_time);
  ...
  void set_receive_time(webrtc::Timestamp value) { receive_time_ = value; }
  // TODO(bugs.webrtc.org/12722): Deprecated, remove once downstream projects
  // are updated.
 ...
 private:
  ...
  webrtc::Timestamp receive_time_;
};

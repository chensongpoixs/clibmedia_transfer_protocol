...
#ifndef _C_CALL_RTP_DEMUXER_H_
#define _C_CALL_RTP_DEMUXER_H_
...
struct RtpDemuxerCriteria {
  ...
  webrtc::flat_set<uint8_t> payload_types;
...
class RtpDemuxer {
 ...
 private:
  ...
  webrtc::flat_map<std::string, RtpPacketSinkInterface*> sink_by_mid_;
  webrtc::flat_map<uint32_t, RtpPacketSinkInterface*> sink_by_ssrc_;
  std::multimap<uint8_t, RtpPacketSinkInterface*> sinks_by_pt_;
  webrtc::flat_map<std::pair<std::string, std::string>, RtpPacketSinkInterface*>
      sink_by_mid_and_rsid_;
  webrtc::flat_map<std::string, RtpPacketSinkInterface*> sink_by_rsid_;
  ...
  // unknown.
  webrtc::flat_set<std::string> known_mids_;
  ...
  webrtc::flat_map<uint32_t, std::string> mid_by_ssrc_;
  webrtc::flat_map<uint32_t, std::string> rsid_by_ssrc_;

...
#ifndef _C_MEDIA_SCTP_SCTP_TRANSPORT_INTERNAL_H_
#define _C_MEDIA_SCTP_SCTP_TRANSPORT_INTERNAL_H_
...
class SctpTransportInternal {
 public:
  ...
  virtual void SetDtlsTransport(libice::PacketTransportInternal* transport) = 0;

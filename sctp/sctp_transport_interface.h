...
#ifndef _C_API_SCTP_TRANSPORT_INTERFACE_H_
#define _C_API_SCTP_TRANSPORT_INTERFACE_H_
...
class RTC_EXPORT SctpTransportInformation {
 public:
  ...
  rtc::scoped_refptr<libice::DtlsTransportInterface> dtls_transport() const {
 ...
 private:
  ...
  rtc::scoped_refptr<libice::DtlsTransportInterface> dtls_transport_;
...
class SctpTransportInterface : public rtc::RefCountInterface {
 public:
  ...
  virtual rtc::scoped_refptr<libice::DtlsTransportInterface> dtls_transport() const = 0;

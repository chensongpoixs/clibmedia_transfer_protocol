...
#ifndef _C_MODULES_RTP_RTCP_SOURCE_ABSOLUTE_CAPTURE_TIME_SENDER_H_
#define _C_MODULES_RTP_RTCP_SOURCE_ABSOLUTE_CAPTURE_TIME_SENDER_H_
...
class AbsoluteCaptureTimeSender {
 public:
  static constexpr webrtc::TimeDelta kInterpolationMaxInterval =
	  webrtc::TimeDelta::Millis(1000);
  static constexpr webrtc::TimeDelta kInterpolationMaxError = webrtc::TimeDelta::Millis(1);

  explicit AbsoluteCaptureTimeSender(webrtc::Clock* clock);
 ...
 private:
  ...
  webrtc::Timestamp last_send_time_ RTC_GUARDED_BY(mutex_);

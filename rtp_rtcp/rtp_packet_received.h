...
#ifndef _C_MODULES_RTP_RTCP_SOURCE_RTP_PACKET_RECEIVED_H_
#define _C_MODULES_RTP_RTCP_SOURCE_RTP_PACKET_RECEIVED_H_
...
class RtpPacketReceived : public RtpPacket {
 ...
 private:
  webrtc::Timestamp arrival_time_ = webrtc::Timestamp::MinusInfinity();

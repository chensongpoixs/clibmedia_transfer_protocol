...
#include "libmedia_transfer_protocol/rtp_rtcp/receive_statistics_impl.h"
...
StreamStatisticianImpl::StreamStatisticianImpl(uint32_t ssrc,
    ...
    : ssrc_(ssrc),
      ...
      incoming_bitrate_(kStatisticsProcessIntervalMs,
		  webrtc::RateStatistics::kBpsScale),
...
std::unique_ptr<ReceiveStatistics> ReceiveStatistics::Create(webrtc::Clock* clock) {
  return std::make_unique<ReceiveStatisticsLocked>(
      clock, [](uint32_t ssrc, webrtc::Clock* clock, int max_reordering_threshold) {

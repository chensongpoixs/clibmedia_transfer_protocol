...
#ifndef _C_MODULES_RTP_RTCP_INCLUDE_RTP_RTCP_H_
#define _C_MODULES_RTP_RTCP_INCLUDE_RTP_RTCP_H_
...
class RtpRtcp : public webrtc::Module, public RtpRtcpInterface {
 public:

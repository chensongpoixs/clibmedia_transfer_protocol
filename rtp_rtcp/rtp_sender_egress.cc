...
constexpr webrtc::TimeDelta kUpdateInterval =
webrtc::TimeDelta::Millis(kBitrateStatisticsWindowMs);

bool IsTrialSetTo(const webrtc::WebRtcKeyValueConfig* field_trials,
...
RtpSenderEgress::RtpSenderEgress(const RtpRtcpInterface::Configuration& config,
  ...
  if (bitrate_callback_) {
    update_task_ = webrtc::RepeatingTaskHandle::DelayedStart(worker_queue_,

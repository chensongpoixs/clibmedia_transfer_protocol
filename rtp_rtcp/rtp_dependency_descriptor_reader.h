...
#ifndef _C_MODULES_RTP_RTCP_SOURCE_RTP_DEPENDENCY_DESCRIPTOR_READER_H_
#define _C_MODULES_RTP_RTCP_SOURCE_RTP_DEPENDENCY_DESCRIPTOR_READER_H_
...
class RtpDependencyDescriptorReader {
 ...
 private:
  ...
  webrtc::BitstreamReader buffer_;

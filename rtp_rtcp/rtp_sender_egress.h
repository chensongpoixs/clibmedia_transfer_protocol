...
#ifndef _C_MODULES_RTP_RTCP_SOURCE_RTP_SENDER_EGRESS_H_
#define _C_MODULES_RTP_RTCP_SOURCE_RTP_SENDER_EGRESS_H_
...
#include "libmedia_transfer_protocol/rtp_rtcp/rtp_sequence_number_map.h"
...
class RtpSenderEgress {
 public:
  ...
  void SetFecProtectionParameters(const webrtc::FecProtectionParams& delta_params,
 ...
 private:
  ...
  RTC_NO_UNIQUE_ADDRESS webrtc::SequenceChecker pacer_checker_;
  ...
  absl::optional<std::pair<webrtc::FecProtectionParams, webrtc::FecProtectionParams>>
  ...
  webrtc::RepeatingTaskHandle update_task_ RTC_GUARDED_BY(worker_queue_);

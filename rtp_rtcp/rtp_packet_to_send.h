...
#ifndef _C_MODULES_RTP_RTCP_SOURCE_RTP_PACKET_TO_SEND_H_
#define _C_MODULES_RTP_RTCP_SOURCE_RTP_PACKET_TO_SEND_H_
 ...
 public:
  ...
  void set_packetization_finish_time_ms(int64_t time) {
    SetExtension<VideoTimingExtension>(
        webrtc::VideoSendTiming::GetDeltaCappedMs(capture_time_ms_, time),

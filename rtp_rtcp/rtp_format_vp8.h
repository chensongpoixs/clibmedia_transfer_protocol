...
#ifndef _C_MODULES_RTP_RTCP_SOURCE_RTP_FORMAT_VP8_H_
#define _C_MODULES_RTP_RTCP_SOURCE_RTP_FORMAT_VP8_H_
...
class RtpPacketizerVp8 : public RtpPacketizer {
 ...
 private:
  ...
  static RawHeader BuildHeader(const webrtc::RTPVideoHeaderVP8& header);

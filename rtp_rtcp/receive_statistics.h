...
#ifndef _C_MODULES_RTP_RTCP_INCLUDE_RECEIVE_STATISTICS_H_
#define _C_MODULES_RTP_RTCP_INCLUDE_RECEIVE_STATISTICS_H_
...
class ReceiveStatistics : public ReceiveStatisticsProvider,
 ...
 public:
  ...
  static std::unique_ptr<ReceiveStatistics> Create(webrtc::Clock* clock);

...
constexpr webrtc::Timestamp kInvalidLastReceiveTime = webrtc::Timestamp::MinusInfinity();
}  // namespace

constexpr webrtc::TimeDelta AbsoluteCaptureTimeInterpolator::kInterpolationMaxInterval;

AbsoluteCaptureTimeInterpolator::AbsoluteCaptureTimeInterpolator(webrtc::Clock* clock)
...
AbsoluteCaptureTimeInterpolator::OnReceivePacket(
  ...
  const webrtc::Timestamp receive_time = clock_->CurrentTime();

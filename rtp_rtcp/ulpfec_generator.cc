...
#include "libmedia_transfer_protocol/rtp_rtcp/ulpfec_generator.h"
...
UlpfecGenerator::Params::Params(webrtc::FecProtectionParams delta_params,
...
UlpfecGenerator::UlpfecGenerator(int red_payload_type,
    ...
    : red_payload_type_(red_payload_type),
      ...
      fec_bitrate_(/*max_window_size_ms=*/1000, webrtc::RateStatistics::kBpsScale) {}
...
const webrtc::FecProtectionParams& UlpfecGenerator::CurrentParams() const {
  RTC_DCHECK_RUNS_SERIALIZED(&race_checker_);
...
webrtc::DataRate UlpfecGenerator::CurrentFecRate() const {
	webrtc::MutexLock lock(&mutex_);
  return webrtc::DataRate::BitsPerSec(

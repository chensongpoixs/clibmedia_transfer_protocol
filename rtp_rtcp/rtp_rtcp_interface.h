...
#ifndef _C_MODULES_RTP_RTCP_SOURCE_RTP_RTCP_INTERFACE_H_
#define _C_MODULES_RTP_RTCP_SOURCE_RTP_RTCP_INTERFACE_H_
...
class RtpRtcpInterface : public RtcpFeedbackSenderInterface {
 public:
  struct Configuration {
    ...
    // client.
    webrtc::RemoteBitrateEstimator* remote_bitrate_estimator = nullptr;
	...
	webrtc::RateLimiter* retransmission_rate_limiter = nullptr;
  ...
  struct SenderReportStats {
    ...
    webrtc::NtpTime last_arrival_timestamp;
    // Received (a.k.a., remote) NTP timestamp for the last received RTCP SR.
	webrtc::NtpTime last_remote_timestamp;
  ...
  virtual bool TrySendPacket(RtpPacketToSend* packet,
                             const libice::PacedPacketInfo& pacing_info) = 0;
  ...
  virtual void SetFecProtectionParams(
      ...
      const webrtc::FecProtectionParams& key_params) = 0;
  ...
  virtual void SetVideoBitrateAllocation(
      const webrtc::VideoBitrateAllocation& bitrate) = 0;

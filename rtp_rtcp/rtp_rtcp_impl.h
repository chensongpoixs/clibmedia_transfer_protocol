...
#ifndef _C_MODULES_RTP_RTCP_SOURCE_RTP_RTCP_IMPL_H_
#define _C_MODULES_RTP_RTCP_SOURCE_RTP_RTCP_IMPL_H_
...
#include "libmedia_transfer_protocol/rtp_rtcp/rtp_rtcp.h"
#include "libmedia_transfer_protocol/rtp_rtcp/rtp_rtcp_defines.h"  // RTCPPacketType
#include "libmedia_transfer_protocol/rtp_rtcp/deprecated/deprecated_rtp_sender_egress.h"
...
class ModuleRtpRtcpImpl : public RtpRtcp, public RTCPReceiver::ModuleRtpRtcp {
 ...
 protected:
  ...
  webrtc::Clock* clock() const { return clock_; }
 ...
 private:
  ...
  struct RtpSenderContext {
    ...
    mutable webrtc::Mutex sequencer_mutex;

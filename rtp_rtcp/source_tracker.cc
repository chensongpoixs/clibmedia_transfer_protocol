...
#include "libmedia_transfer_protocol/rtp_rtcp/source_tracker.h"
...
SourceTracker::SourceTracker(webrtc::Clock* clock) : clock_(clock) {}
...
void SourceTracker::OnFrameDelivered(const RtpPacketInfos& packet_infos) {
  ...
  webrtc::MutexLock lock_scope(&lock_);

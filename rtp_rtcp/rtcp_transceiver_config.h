...
#ifndef _C_MODULES_RTP_RTCP_SOURCE_RTCP_TRANSCEIVER_CONFIG_H_
#define _C_MODULES_RTP_RTCP_SOURCE_RTCP_TRANSCEIVER_CONFIG_H_
...
class NetworkLinkRtcpObserver {
 public:
  ...
  virtual void OnTransportFeedback(webrtc::Timestamp receive_time,
                                   const rtcp::TransportFeedback& feedback) {}
  virtual void OnReceiverEstimatedMaxBitrate(webrtc::Timestamp receive_time,

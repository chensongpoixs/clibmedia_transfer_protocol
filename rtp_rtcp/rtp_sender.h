...
#ifndef __C_MODULES_RTP_RTCP_SOURCE_RTP_SENDER_H_
#define __C_MODULES_RTP_RTCP_SOURCE_RTP_SENDER_H_
...
class RTPSender {
 ...
 private:
  ...
  webrtc::Random random_ RTC_GUARDED_BY(send_mutex_);
  ...
  mutable webrtc::Mutex send_mutex_;
  ...
  webrtc::RateLimiter* const retransmission_rate_limiter_;
};

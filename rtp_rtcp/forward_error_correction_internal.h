...
#ifndef _C_MODULES_RTP_RTCP_SOURCE_FORWARD_ERROR_CORRECTION_INTERNAL_H_
#define _C_MODULES_RTP_RTCP_SOURCE_FORWARD_ERROR_CORRECTION_INTERNAL_H_
...
class PacketMaskTable {
 public:
  PacketMaskTable(webrtc::FecMaskType fec_mask_type, int num_media_packets);
  ~PacketMaskTable();
 ...
 private:
  static const uint8_t* PickTable(webrtc::FecMaskType fec_mask_type,

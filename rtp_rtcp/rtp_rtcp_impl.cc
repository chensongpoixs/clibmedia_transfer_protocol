...
uint16_t ModuleRtpRtcpImpl::SequenceNumber() const {
  webrtc::MutexLock lock(&rtp_sender_->sequencer_mutex);
...
void ModuleRtpRtcpImpl::SetFecProtectionParams(const webrtc::FecProtectionParams&,
                                               const webrtc::FecProtectionParams&) {

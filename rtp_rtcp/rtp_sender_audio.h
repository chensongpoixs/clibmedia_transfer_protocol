...
#ifndef _C_MODULES_RTP_RTCP_SOURCE_RTP_SENDER_AUDIO_H_
#define _C_MODULES_RTP_RTCP_SOURCE_RTP_SENDER_AUDIO_H_
...
#include "libmedia_transfer_protocol/rtp_rtcp/dtmf_queue.h"
...
class RTPSenderAudio {
 public:
  RTPSenderAudio(webrtc::Clock* clock, RTPSender* rtp_sender);
  ...
  bool SendAudio(webrtc::AudioFrameType frame_type,
                 int8_t payload_type,
 ...
 protected:
  ...
  bool MarkerBit(webrtc::AudioFrameType frame_type, int8_t payload_type);

 private:
  webrtc::Clock* const clock_ = nullptr;
  RTPSender* const rtp_sender_ = nullptr;

  webrtc::Mutex send_audio_mutex_;
  ...
  webrtc::OneTimeEvent first_packet_sent_;

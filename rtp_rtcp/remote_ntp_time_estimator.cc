...
#include "libmedia_transfer_protocol/rtp_rtcp/remote_ntp_time_estimator.h"
...
// vie_sync_module.cc.
RemoteNtpTimeEstimator::RemoteNtpTimeEstimator(webrtc::Clock* clock)
    : clock_(clock),
...
bool RemoteNtpTimeEstimator::UpdateRtcpTimestamp(int64_t rtt,
  ...
  int64_t sender_send_time_ms = webrtc::NtpTime(ntp_secs, ntp_frac).ToMs();

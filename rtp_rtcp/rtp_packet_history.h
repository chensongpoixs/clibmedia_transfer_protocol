...
#ifndef _C_MODULES_RTP_RTCP_SOURCE_RTP_PACKET_HISTORY_H_
#define _C_MODULES_RTP_RTCP_SOURCE_RTP_PACKET_HISTORY_H_
...
class RtpPacketHistory {
 public:
  ...
  RtpPacketHistory(webrtc::Clock* clock, bool enable_padding_prio);

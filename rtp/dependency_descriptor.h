...
#ifndef _C_API_TRANSPORT_RTP_DEPENDENCY_DESCRIPTOR_H_
#define _C_API_TRANSPORT_RTP_DEPENDENCY_DESCRIPTOR_H_
...
struct FrameDependencyStructure {
  ...
  absl::InlinedVector<webrtc::RenderResolution, 4> resolutions;
...
struct DependencyDescriptor {
  ...
  absl::optional<webrtc::RenderResolution> resolution;

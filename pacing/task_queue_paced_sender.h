...
#ifndef _C_MODULES_PACING_TASK_QUEUE_PACED_SENDER_H_
#define _C_MODULES_PACING_TASK_QUEUE_PACED_SENDER_H_
...
class TaskQueuePacedSender : public RtpPacketPacer, public RtpPacketSender {
 public:
  ...
  TaskQueuePacedSender(
    ...
    //  const WebRtcKeyValueConfig* field_trials,
	  ...
	  webrtc::TimeDelta hold_back_window = PacingController::kMinSleepTime);
  ...
  void CreateProbeCluster(webrtc::DataRate bitrate, int cluster_id) override;
  ...
  void SetCongestionWindow(webrtc::DataSize congestion_window_size) override;
  void UpdateOutstandingData(webrtc::DataSize outstanding_data) override;

  // Sets the pacing rates. Must be called once before packets can be sent.
  void SetPacingRates(webrtc::DataRate pacing_rate, webrtc::DataRate padding_rate) override;
  ...
  absl::optional<webrtc::Timestamp> FirstSentPacketTime() const override;
 ...
 protected:
  ...
  struct Stats {
    Stats()
        : oldest_packet_wait_time(webrtc::TimeDelta::Zero()),
          queue_size(webrtc::DataSize::Zero()),
          expected_queue_time(webrtc::TimeDelta::Zero()) {}
	webrtc::TimeDelta oldest_packet_wait_time;
	webrtc::DataSize queue_size;
	webrtc::TimeDelta expected_queue_time;
    absl::optional<webrtc::Timestamp> first_sent_packet_time;
  };
 ...
 private:
  ...
  webrtc::Timestamp last_stats_time_ RTC_GUARDED_BY(task_queue_);
...
#endif  // _C_MODULES_PACING_TASK_QUEUE_PACED_SENDER_H_

...
#ifndef _C_MODULES_PACING_RTP_PACKET_PACER_H_
#define _C_MODULES_PACING_RTP_PACKET_PACER_H_
...
class RtpPacketPacer {
 public:
  ...
  virtual void CreateProbeCluster(webrtc::DataRate bitrate, int cluster_id) = 0;
  ...
  virtual void SetCongestionWindow(webrtc::DataSize congestion_window_size) = 0;
  virtual void UpdateOutstandingData(webrtc::DataSize outstanding_data) = 0;
  ...
  virtual absl::optional<webrtc::Timestamp> FirstSentPacketTime() const = 0;

...
#ifndef _C_API_FRAME_TRANSFORMER_INTERFACE_H_
#define _C_API_FRAME_TRANSFORMER_INTERFACE_H_
...
class TransformableVideoFrameInterface : public TransformableFrameInterface {
 public:
  ...
  //virtual const webrtc::VideoFrameMetadata& GetMetadata() const = 0;
};
...
class TransformableAudioFrameInterface : public TransformableFrameInterface {
 public:
  ...
  // csrcs.
  virtual const libmedia_transfer_protocol::RTPHeader& GetHeader() const = 0;
};

 ...
 ******************************************************************************/
#ifndef _C_CALL_RTP_STREAM_RECEIVER_CONTROLLER_H_
#define _C_CALL_RTP_STREAM_RECEIVER_CONTROLLER_H_

#include <memory>

#include "api/sequence_checker.h"
#include "libmedia_transfer_protocol/rtp_demuxer.h"
#include "libmedia_transfer_protocol/rtp_stream_receiver_controller_interface.h"
...
class RtpStreamReceiverController
 ...
 private:
  ...
  // of Call).
  webrtc::SequenceChecker demuxer_sequence_;

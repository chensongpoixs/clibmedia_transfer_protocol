...
#ifndef  _C_ACKNOWLEDGED_BITRATE_ESTIMATOR_INTERFACE_H_
#define  _C_ACKNOWLEDGED_BITRATE_ESTIMATOR_INTERFACE_H_
...
struct RobustThroughputEstimatorSettings {
 ...
 // RobustThroughputEstimatorSettings() = default;
  ...
  webrtc:: TimeDelta window_duration = webrtc::TimeDelta::Millis(500);
...
class AcknowledgedBitrateEstimatorInterface {
 public:
  ...
  virtual void IncomingPacketFeedbackVector(
      const std::vector<libice::PacketResult>& packet_feedback_vector) = 0;
  virtual absl::optional<webrtc::DataRate> bitrate() const = 0;
  virtual absl::optional<webrtc::DataRate> PeekRate() const = 0;

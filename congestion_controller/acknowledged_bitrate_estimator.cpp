...
void AcknowledgedBitrateEstimator::IncomingPacketFeedbackVector(
  ...
  for (const auto& packet : packet_feedback_vector) {
    ...
    webrtc::DataSize acknowledged_estimate = packet.sent_packet.size;
...
absl::optional<webrtc::DataRate> AcknowledgedBitrateEstimator::PeekRate() const {
  return bitrate_estimator_->PeekRate();
}

void AcknowledgedBitrateEstimator::SetAlrEndedTime(webrtc::Timestamp alr_ended_time) {

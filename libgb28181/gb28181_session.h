...
#ifndef _C_LIBGB28181_SESSION_H_
#define _C_LIBGB28181_SESSION_H_
...
namespace  libmedia_transfer_protocol {
	namespace libgb28181
	{
		...
		class Gb28181Session : public   sigslot::has_slots<>
		{
		public:

			explicit Gb28181Session(rtc::Socket* socket, rtc::Thread* work_thread);

			virtual ~Gb28181Session();
		public:

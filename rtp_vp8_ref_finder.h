...
#ifndef _C_MODULES_VIDEO_CODING_RTP_VP8_REF_FINDER_H_
#define _C_MODULES_VIDEO_CODING_RTP_VP8_REF_FINDER_H_
...
class RtpVp8RefFinder {
 ...
 private:
  ...
  void UpdateLayerInfoVp8(libmedia_codec::RtpFrameObject* frame,
                          int64_t unwrapped_tl0,
                          uint8_t temporal_idx);
  void UnwrapPictureIds(libmedia_codec::RtpFrameObject* frame);

...
#ifndef _C_MODULES_VIDEO_CODING_RTP_FRAME_REFERENCE_FINDER_H_
#define _C_MODULES_VIDEO_CODING_RTP_FRAME_REFERENCE_FINDER_H_
...
class RtpFrameReferenceFinder {
 public:
  using ReturnVector = absl::InlinedVector<std::unique_ptr<libmedia_codec::RtpFrameObject>, 3>;
  ...
  ReturnVector ManageFrame(std::unique_ptr<libmedia_codec::RtpFrameObject> frame);
